...
2. Média de preço com frete por Nome de Departamento: Para entender o comportamento de preço por nome de departamento, podemos calcular a média de preço com frete por departamento. Essa metrica pode ajudar a identificar quais são os departamentos mais rentáveis e ajustar a precificação de produtos de acordo com a margem de lucro desejada.

3. Quantidade de vendas por Més: Analisando a quantidade de vendas realizadas em cada més, podemos identificar sazonalidades no comportamento de copras e  planejar campanhas de marketing especificas para cada período.
